...
public:
	...
	bool HELP_SID_AUTH_CHECK( bool TFT, bool PTR, uint32_t war3Version, std::string war3Path, std::string keyROC, std::string keyTFT, std::string valueStringFormula, std::string mpqFileName, BYTEARRAY clientToken, BYTEARRAY serverToken );
