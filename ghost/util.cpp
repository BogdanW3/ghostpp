...
BYTEARRAY UTIL_CreateByteArray( unsigned char *a, size_t size )
{
	if( size < 1 )
		return BYTEARRAY( );
...
void UTIL_AppendByteArray( BYTEARRAY &b, unsigned char *a, size_t size )
{
...
unsigned char UTIL_ExtractHex( BYTEARRAY &b, size_t start, bool reverse )
{
